function [ C1, C2 ] = Output( lambdaC, mu_I_C, mu_S_C, B_1, zo)
...
C1(5,:) = (mu_S_C(17)) * B_1(:,17)';
C1(6,:) = (lambdaC(14) * B_1(:,14)' + mu_S_C(15) * B_1(:,15)') ;
C1(7,:) = (mu_S_C(23)) * B_1(:,23)';
C1(8,:) = (lambdaC(21) * B_1(:,21)' + mu_S_C(22) * B_1(:,22)');
