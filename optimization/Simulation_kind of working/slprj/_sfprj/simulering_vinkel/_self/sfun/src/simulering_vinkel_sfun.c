  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==2) {
    c2_simulering_vinkel_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
       ...
       case 2:
        {
          ...
          sf_c2_simulering_vinkel_get_check_sum(plhs);
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "cCrifb4Ieupwb1sZGTo0cH") == 0) {
          extern mxArray *sf_c2_simulering_vinkel_get_autoinheritance_info(void);
          plhs[0] = sf_c2_simulering_vinkel_get_autoinheritance_info();
          break;
        }
     ...
     case 2:
      {
        extern const mxArray
          *sf_c2_simulering_vinkel_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_simulering_vinkel_get_eml_resolved_functions_info();
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s7opLpJU6kIUOFF4hatDQbH") == 0) {
          extern mxArray *sf_c2_simulering_vinkel_third_party_uses_info(void);
          plhs[0] = sf_c2_simulering_vinkel_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s7opLpJU6kIUOFF4hatDQbH") == 0) {
          extern mxArray *sf_c2_simulering_vinkel_jit_fallback_info(void);
          plhs[0] = sf_c2_simulering_vinkel_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(tpChksum, "s7opLpJU6kIUOFF4hatDQbH") == 0) {
          extern mxArray *sf_c2_simulering_vinkel_updateBuildInfo_args_info(void);
          plhs[0] = sf_c2_simulering_vinkel_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  debugInstance)
{
  _simulering_vinkelMachineNumber_ = sf_debug_initialize_machine(debugInstance,
    "simulering_vinkel","sfun",0,3,0,0,0);
