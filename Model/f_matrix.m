...
e1 = ((2/k_v100^2)-A_h2_1)*q(1)*abs(q(1)) + A_h1_1*omega(1)*q(1) + A_h0_1*omega(1)^2;
e8 = ((2/k_v100^2)-A_h2_1)*q(8)*abs(q(8)) + A_h1_1*omega(2)*q(8) + A_h0_1*omega(2)^2;
%Grundfos UPM2 25-60 180 pump 
e9 = ((2/k_v100^2)-A_h2_2)*q(9)*abs(q(9)) + A_h1_2*omega(3)*q(9) + A_h0_2*omega(3)^2;
e16 = ((2/k_v100^2)-A_h2_2)*q(16)*abs(q(16)) + A_h1_2*omega(4)*q(16) + A_h0_2*omega(4)^2;
